...
RENAME TABLE sakila.payment_type
TO sakila.payment_types;
...
SELECT 12 * (rental_rate/rental_duration) AS rental_cost
FROM sakila.film
...
FROM sakila.rental
WHERE rental_date BETWEEN '2005-02-01 00:00:00' AND '2005-05-31 23:59:59';
